      ...
      body: ListView.separated(
        ...
        itemBuilder: (context, index) {
          return ListTile(
            onTap: () {
              switch(index){
                case 0 : Navigator.push(context, MaterialPageRoute(builder: (context) => DeepWork(),),);
                    break;
                case 1 : Navigator.push(context, MaterialPageRoute(builder: (context) => ThingsDone(),),);
                break;
                case 2 : Navigator.push(context, MaterialPageRoute(builder: (context) => sevenHabits(),),);
                break;
                case 3 : Navigator.push(context, MaterialPageRoute(builder: (context) => EatFrog(),),);
                break;
                case 4 : Navigator.push(context, MaterialPageRoute(builder: (context) => hundredsixtyeghtHours(),),);
                break;
                case 5 : Navigator.push(context, MaterialPageRoute(builder: (context) => eightyTwentyPrinciple(),),);
                break;
                case 6 : Navigator.push(context, MaterialPageRoute(builder: (context) => Essentialism(),),);
                break;
                case 7 : Navigator.push(context, MaterialPageRoute(builder: (context) => productivity(),),);
                break;
                case 8 : Navigator.push(context, MaterialPageRoute(builder: (context) => OraganizeTodayTommorow(),),);
                break;
                case 9 : Navigator.push(context, MaterialPageRoute(builder: (context) => FourThousandWeeks(),),);
                break;
              }
...
class DeepWork extends StatefulWidget {
  const DeepWork({Key? key}) : super(key: key);

  @override
  State<DeepWork> createState() => _DeepWorkState();
}
          ...
          children: [
            Center(
              child: Container(
                ...
                child: Image(
                  image: AssetImage('images/Deep-work.jpg'),
                ),
              ),
            ),
            SizedBox(
            ...
            Container(
              ...
              child: Text('Deep Work is one of the best books on time management and productivity. '
...
class ThingsDone extends StatefulWidget {
  const ThingsDone({Key? key}) : super(key: key);

  @override
  State<ThingsDone> createState() => _ThingsDoneState();
}

class _ThingsDoneState extends State<ThingsDone> {
  @override
  Widget build(BuildContext context) {
    return  Scaffold(
      backgroundColor: Colors.teal.shade200,
          ...
          children: [
            Center(
              child: Container(
                ...
                color: Colors.transparent,
                child: Image(
                  image: AssetImage('images/getting-things-done.jpg'),
                ),
              ),
            ),
            SizedBox(
            ...
            Container(
              padding: EdgeInsets.all(8),
              color: Colors.grey.shade200,
              child: Text('Getting Things Done is one of the best selling time management improvement books. '
            ...
            Container(
              padding: EdgeInsets.all(8),
              color: Colors.grey.shade200,
              child: Text('Notable Quote: “If you don’t pay appropriate attention to what has your attention,'
...
class sevenHabits extends StatefulWidget {
  const sevenHabits({Key? key}) : super(key: key);

  @override
  State<sevenHabits> createState() => _sevenHabitsState();
}

class _sevenHabitsState extends State<sevenHabits> {
  @override
  Widget build(BuildContext context) {
    return  Scaffold(
      backgroundColor: Colors.teal.shade200,
          ...
          children: [
            Center(
              child: Container(
                ...
                color: Colors.transparent,
                child: Image(
                  image: AssetImage('images/7Habit.jpg'),
                ),
              ),
            ),
            SizedBox(
            ...
            Container(
              padding: EdgeInsets.all(8),
              color: Colors.grey.shade200,
              child: Text('The 7 Habits of Highly Effective People is one of the most popular time management books of all time.'
            ...
            Container(
              padding: EdgeInsets.all(8),
              color: Colors.grey.shade200,
              child: Text('Notable Quote: “But until a person can say deeply and honestly,'
...
class EatFrog extends StatefulWidget {
  const EatFrog({Key? key}) : super(key: key);

  @override
  State<EatFrog> createState() => _EatFrogState();
}

class _EatFrogState extends State<EatFrog> {
  @override
  Widget build(BuildContext context) {
    return  Scaffold(
      backgroundColor: Colors.teal.shade200,
          ...
          children: [
            Center(
              child: Container(
                ...
                color: Colors.transparent,
                child: Image(
                  image: AssetImage('images/eat-that-frog.jpg'),
                ),
              ),
            ),
            SizedBox(
            ...
            Container(
              padding: EdgeInsets.all(8),
              color: Colors.grey.shade200,
              child: Text('Mark Twain famously said, “if it’s your job to eat a frog, '
            ...
            Container(
              padding: EdgeInsets.all(8),
              color: Colors.grey.shade200,
              child: Text('Notable Quote: “One of the very worst uses of time is'
...
class eightyTwentyPrinciple extends StatefulWidget {
  const eightyTwentyPrinciple({Key? key}) : super(key: key);

  @override
  State<eightyTwentyPrinciple> createState() => _eightyTwentyPrincipleState();
}

class _eightyTwentyPrincipleState extends State<eightyTwentyPrinciple> {
  @override
  Widget build(BuildContext context) {
    return  Scaffold(
      backgroundColor: Colors.teal.shade200,
          ...
          children: [
            Center(
              child: Container(
                ...
                color: Colors.transparent,
                child: Image(
                  image: AssetImage('images/The-8020-Principle.jpg'),
                ),
              ),
            ),
            SizedBox(
            ...
            Container(
              padding: EdgeInsets.all(8),
              color: Colors.grey.shade200,
              child: Text('The 80/20 Principle is a manifesto for accomplishing great results with minimal effort. '
            ...
            Container(
              padding: EdgeInsets.all(8),
              color: Colors.grey.shade200,
              child: Text('Notable Quote: “It is not shortage of time that should worry us, '
...
class Essentialism extends StatefulWidget {
  const Essentialism({Key? key}) : super(key: key);

  @override
  State<Essentialism> createState() => _EssentialismState();
}

class _EssentialismState extends State<Essentialism> {
  @override
  Widget build(BuildContext context) {
    return  Scaffold(
      backgroundColor: Colors.teal.shade200,
          ...
          children: [
            Center(
              child: Container(
                ...
                color: Colors.transparent,
                child: Image(
                  image: AssetImage('images/essentialism1.jpg'),
                ),
              ),
            ),
            SizedBox(
            ...
            Container(
              padding: EdgeInsets.all(8),
              color: Colors.grey.shade200,
              child: Text('Essentialism: The Disciplined Pursuit of Less is one of the most helpful time and stress management'
            ...
            Container(
              padding: EdgeInsets.all(8),
              color: Colors.grey.shade200,
              child: Text('Notable Quote: “Essentialists see trade-offs as an inherent part of life, '
          ...
          children: [
            Center(
              child: Container(
                ...
                color: Colors.transparent,
                child: Image(
                  image: AssetImage('images/the-productivity-project.jpg'),
                ),
              ),
            ),
            SizedBox(
            ...
            Container(
              padding: EdgeInsets.all(8),
              color: Colors.grey.shade200,
              child: Text('The Productivity Project is a study that centers around finding ideal working conditions.'
            ...
            Container(
              padding: EdgeInsets.all(8),
              color: Colors.grey.shade200,
              child: Text('Notable Quote: “Busyness is no different from laziness when '
...
class OraganizeTodayTommorow extends StatefulWidget {
  const OraganizeTodayTommorow({Key? key}) : super(key: key);

  @override
  State<OraganizeTodayTommorow> createState() => _OraganizeTodayTommorowState();
}

class _OraganizeTodayTommorowState extends State<OraganizeTodayTommorow> {
  @override
  Widget build(BuildContext context) {
    return  Scaffold(
      backgroundColor: Colors.teal.shade200,
          ...
          children: [
            Center(
              child: Container(
                ...
                color: Colors.transparent,
                child: Image(
                  image: AssetImage('images/organize-tomorrow-today.jpg'),
                ),
              ),
            ),
            SizedBox(
            ...
            Container(
              padding: EdgeInsets.all(8),
              color: Colors.grey.shade200,
              child: Text('Organize Tomorrow Today is a book that emphasizes the '
            ...
            Container(
              padding: EdgeInsets.all(8),
              color: Colors.grey.shade200,
              child: Text('Notable Quote: “Greatness is predicated on consistently doing things others '
...
class FourThousandWeeks extends StatefulWidget {
  const FourThousandWeeks({Key? key}) : super(key: key);

  @override
  State<FourThousandWeeks> createState() => _FourThousandWeeksState();
}

class _FourThousandWeeksState extends State<FourThousandWeeks> {
  @override
  Widget build(BuildContext context) {
    return  Scaffold(
      backgroundColor: Colors.teal.shade200,
          ...
          children: [
            Center(
              child: Container(
                ...
                color: Colors.transparent,
                child: Image(
                  image: AssetImage('images/four-thousand-weeks.jpg',),
                  fit: BoxFit.cover,
                ),
            ...
            Container(
              padding: EdgeInsets.all(8),
              color: Colors.grey.shade200,
              child: Text('Four Thousand Weeks is one of the newest books about managing time. '
                  ...
                  'Oliver Burkeman challenges modern productivity norms and questions the quest to stay forever busy. Four Thousand Weeks reminds readers that life is short, and suggests strategies for spending time on meaningful pursuits. The book also explains how to overcome anxiety over the uncontrollable and be more mindful of the moment instead of projecting into the future.'),
            ),
            SizedBox(
              height: 5,
            ),
            Container(
              padding: EdgeInsets.all(8),
              color: Colors.grey.shade200,
              child: Text('Notable Quote: “The real problem isn’t our limited time. The real problem–or so I hope to convince you– '
...
class hundredsixtyeghtHours extends StatefulWidget {
  const hundredsixtyeghtHours({Key? key}) : super(key: key);

  @override
  State<hundredsixtyeghtHours> createState() => _hundredsixtyeghtHoursState();
}

class _hundredsixtyeghtHoursState extends State<hundredsixtyeghtHours> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Colors.teal.shade200,
          ...
          children: [
            Center(
              child: Container(
                ...
                color: Colors.transparent,
                child: Image(
                  image: AssetImage('images/168-hours.jpg'),
                ),
              ),
            ),
            SizedBox(
            ...
            Container(
              padding: EdgeInsets.all(8),
              color: Colors.grey.shade200,
              child: Text('168 Hours provides a framework for how to structure your days in ways that leave '
            ...
            Container(
              padding: EdgeInsets.all(8),
              color: Colors.grey.shade200,
              child: Text('Notable Quote: “Knock a few of these easy items off first, '
